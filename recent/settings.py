...
with open(file_path, "r", encoding="utf-8") as f:
    ...
    USER_INACTIVE_DAYS: int = _policy.get('USER_INACTIVE_DAYS', 30)
    USER_NO_BATTLE_DAYS: int = _policy.get('USER_NO_BATTLE_DAYS', 90)
    USER_HIDDEN_PROFILE_DAYS: int = _policy.get('USER_HIDDEN_PROFILE_DAYS', 14)
    USER_REFRESH_TIMEOUT: dict = _policy.get('USER_REFRESH_TIMEOUT', {"1": 86400, "2": 3600})
