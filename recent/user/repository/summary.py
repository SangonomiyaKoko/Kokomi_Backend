...
from models import DailySummary, UserStats, BattleMode
...
class DailySummaryRepository:
    ...
    @classmethod
    def from_stats(cls, stats: UserStats, indices: dict[BattleMode, int | None]) -> DailySummary:
        """从 UserStats 构造一条记录，indices 为各模式索引（None/0/日期 三态）"""
        return DailySummary(
