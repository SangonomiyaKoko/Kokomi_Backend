...
).get(ServicesName.STATS, {})
REFRESH_INTERVAL = _data.get('REFRESH_INTERVAL', 2 * 3600)
REQUEST_TIMEOUT = _data.get('REQUEST_TIMEOUT', 5)
BATCH_SIZE = _data.get('BATCH_SIZE', 1000)
BUCKETS = _data.get('BUCKETS', 400)           # 直方图桶数
MIN_SAMPLES = _data.get('MIN_SAMPLES', 200)   # Rating 统计最低限制
